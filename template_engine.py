...
if __name__ == "__main__":
    ...
    PINS[0].value = True
    PINS[5].value = True
    #we make table content a generator that produces on row per iteration
    ...
    pins_tmp.format(table_content = gen_table_content(PINS), comment='', javascript = pins_jstmp)
